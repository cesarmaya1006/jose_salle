...
<head>
    ...
    <link rel="icon" type="image/vnd.microsoft.icon" href="{{ asset('imagenes/sistema/icono.png') }}"
        sizes="64x64">
    <!-- Bootstrap CSS -->
    <!-- Bootstrap CSS -->
    ...
    <title>Proyectyos la Salle</title>
    @yield('css_pagina')
    <style>
        body {
...
<body>
    ...
    <div class="row fixed-bottom p-3 mt-5" style="background-color: rgba(26, 26, 26, 0.0)">
        <div class="col-12 text-center text-black d-flex flex-row justify-content-center">
            ...
            <strong class="mr-3">Copyright &copy; 2021 UNISALLE</strong> All rights reserved.
            <div class="float-right d-none d-sm-inline-block ml-3">
                <b>Version</b> 1.0.0
            </div>
        </a>
        </div>
